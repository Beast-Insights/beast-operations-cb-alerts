...
const TABS = [
  { href: '/recon', label: 'Health Overview', match: (p: string) => p === '/recon' },
  { href: '/recon/scrapers', label: 'Scrapers', match: (p: string) => p.startsWith('/recon/scrapers') },
]

export default function OpsLayout({ children }: { children: React.ReactNode }) {
  const pathname = usePathname() || '/recon'
  return (
    <div>
